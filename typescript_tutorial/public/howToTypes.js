...
var u_name; // this will be a string, value set later
var u_age;
var u_isLoggedIn;
...
u_isLoggedIn = false;
/* ARRAYS AGAIN */
var ninjas; // this will be a string array
// ninjas = [1,2,3] // won't work
ninjas = ['Anna', 'Berta', 'Carla'];
// initialize as empty array for the push method to work 
var people = []; // this will be a string array, which has no entries yet
people.push('Dora');
people.push('Ella');
console.log(people); // output: Array [ "Dora", "Ella" ]
/* UNION TYPES */
var misto = []; // this is an empty array, which can have values of different types (string, number)
misto.push(20);
misto.push('abc');
...
var uncertain_age = 25; // currently of value 25 (number type), but can still be any type
